...
class Settings(BaseSettings):
    GOOGLE_API_KEY: str = "AIzaSyCFhjX4LdssnKq5BublWYlOwNwHeBwM4CI"
...
# Basic validation
if settings.GOOGLE_API_KEY == "YOUR_DEFAULT_API_KEY_IF_NOT_SET" or not settings.GOOGLE_API_KEY:
    print("WARNING: GOOGLE_API_KEY is not set in the environment or .env file.")
if settings.SECRET_KEY == "default_secret":
    print("WARNING: Using default SECRET_KEY. Please set a strong secret in your .env file.")